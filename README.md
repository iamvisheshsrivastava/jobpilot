...
|-------------|--------|-----|
| 🟢 Production | `production` | [jobpilot-lime.vercel.app](https://jobpilot-lime.vercel.app) |
| 🟡 UAT | `UAT` | [jobpilot-lime-git-uat-srivastava.vercel.app](https://jobpilot-lime-git-uat-srivastava.vercel.app) |
| 🔵 Testing | `testing` | [jobpilot-lime-git-testing-srivastava.vercel.app](https://jobpilot-lime-git-testing-srivastava.vercel.app) |

> Preview URLs for UAT and Testing are auto-generated by Vercel on every push — confirm the exact URLs in your [Vercel Dashboard](https://vercel.com/dashboard) under **Deployments → Branch**.
